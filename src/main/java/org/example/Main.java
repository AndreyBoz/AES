...
import org.example.aesalgorithm.AES;
...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for(int i = 0;i<aes.getEncrypt().length;i++){
            System.out.print((char)(aes.getEncrypt()[i]& 0xFF));
        }
        System.out.println();
        aes = new AES(aes.getEncrypt(),"Bra12345Bra12345".getBytes(),2);
        for(int i = 0;i<aes.getDecript().length;i++){
            System.out.print((char)(aes.getDecript()[i]& 0xFF));
        }
    }

    static void Sout(byte[][] matrix) {
